...
class Result
{
    public static string dayOfProgrammer(int year)
    {
        ...
        int july_days = 31;
        int august_days = 31;
        int september_days = 0;
        int total_days = 0;
        List<int> days_per_month = [
            january_days,
            march_days,
            april_days,
            may_days,
        ...
        foreach(int days in days_per_month){
            total_days += days;
        }
        
        if(year <= 1917 && year%4 == 0){
            february_days = 29;
            total_days += february_days;
        ...
        september_days = 256 - total_days;
        
        string date = september_days + ".09." + year;
